...
/***/ function(module, exports, __webpack_require__) {
	...
	var klass = __webpack_require__(7);
	var elementSize = __webpack_require__(8);
	var elementPosition = __webpack_require__(9);
	var transform = __webpack_require__(10);
	var getElementTransform = __webpack_require__(11);
	var scrollSnap = __webpack_require__(12);
	var vhToPx = __webpack_require__(16);
	var getScrollTop = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Scroll snap
	//
	// Callback when s section is scrolled into view
	//
...
/***/ function(module, exports, __webpack_require__) {
	...
	var windowSize = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slider2 = __webpack_require__(19);
	var p = select('.publishers');
	if (p[0]) { slider2('.publishers__slider .slider2', 1, pubslishersSlideClick); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Slider2(sliderID, step, callback) {
	  ...
	  this.slideWidth = getElementTransform(this.slides[1], 'X');

	  this.firstSlide = this.slides[0];
	  this.lastSlide = this.slides[this.slides.length - 1];
	  this.canNavigate();

	  klass(this.slides[1], 'slide--active', 'add');
	}
	...
	Slider2.prototype.canNavigate = function() {
	  _this = this;
	...
	Slider2.prototype.setNavigationButtonStatus = function() {
	  _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getStartedPopup() {
	  ...
	  click(button, function() {
	    var p = select('.popup')[0];
	    klass(p, 'popup--active', 'add');
	    popup(p, '.icon-hamburger', content);
	  });
	}
